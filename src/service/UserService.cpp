...
oatpp::Vector<oatpp::Object<TornKeyRow>> UserService::getTornKeys(const std::int64_t factionId)
{
...
void UserService::updateFaction(const std::string& tornKey, std::int64_t factionId)
{
