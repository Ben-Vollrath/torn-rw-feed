...
class UserDb : public oatpp::orm::DbClient {
 ...
 public:
  ...
  QUERY(updateFaction,
        ...
        PARAM(oatpp::String, torn_key), PARAM(oatpp::Int64, faction_id))

  QUERY(getById, "SELECT * FROM users WHERE id=:id;", PARAM(oatpp::Int64, id))

  QUERY(deleteById, "DELETE FROM users WHERE id=:id;", PARAM(oatpp::Int64, id))
  ...
  QUERY(deleteAll, "DELETE FROM users;")
};
