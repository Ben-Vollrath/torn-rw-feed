...
class DatabaseComponent {
 public:
  // Provider (backend-specific) toggles between sqlite and postgre depending on
  // environment
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<oatpp::postgresql::ConnectionPool>,
                         connectionPool)
  ([] {
    OATPP_COMPONENT(std::shared_ptr<oatpp::postgresql::ConnectionProvider>,
                    connectionProvider);
    return oatpp::postgresql::ConnectionPool::createShared(
        connectionProvider, 10, std::chrono::seconds(5));
  }());

  OATPP_CREATE_COMPONENT(std::shared_ptr<oatpp::postgresql::Executor>,
                         dbExecutor)
  ([] {
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<TargetsDb>, targetsDb)
  ([] {
    OATPP_COMPONENT(std::shared_ptr<oatpp::postgresql::Executor>, dbExecutor);
