...
class TornFactionWarsDto : public oatpp::DTO {
 ...
 public:
  std::optional<std::int64_t> getEnemyFactionId(std::int64_t factionId) const {
    ...
    OATPP_ASSERT_HTTP(factions->size() == 2,
                      oatpp::web::protocol::http::Status::CODE_502, "502")
  ...
  bool isWarActive() const { return static_cast<bool>(ranked); }
...
class TornFactionWarResponseDto : public oatpp::DTO {
 ...
 public:
  ...
  bool isWarActive() const { return wars ? wars->isWarActive() : false; }
};
