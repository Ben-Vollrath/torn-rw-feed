...
class TargetsDbDto : public oatpp::DTO
{
	...
	static Object<TargetsDbDto> createFromFactionAndUser(std::int64_t enemyFactionId, std::int64_t userId)
	{
...
class UpdateTargetDto : public oatpp::DTO
{
	...
	static Vector<Object<UpdateTargetDto>> fromTargetsDto(const Object<TargetsDto>& targetsDto)
	{
