...
v_int32 Lobby::obtainNewPeerId() { return m_userIdCounter++; }

std::optional<std::shared_ptr<Room>> Lobby::getRoomNullable(
...
void Lobby::onAfterCreate_NonBlocking(
  ...
  OATPP_LOGD(TAG, "onAfterCreate_NonBlocking called, userId: %s",
             userIdText->c_str());
