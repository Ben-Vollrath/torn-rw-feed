...
class TestComponent {
 public:
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<FFScouterApiClient>,
                         ffScouterApiClient)
  ([] {
    /* Get client connection provider for Api Client */
    OATPP_COMPONENT(std::shared_ptr<oatpp::network::ClientConnectionProvider>,
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<TornStatsApiClient>,
                         tornStatsApiClient)
  ([] {
    /* Get client connection provider for Api Client */
    OATPP_COMPONENT(std::shared_ptr<oatpp::network::ClientConnectionProvider>,
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<MockResponseLoader>,
                         mockResponseLoader)
